...
int Fl_Image_Button::getrow() {return row;}
int Fl_Image_Button::getcol() {return col;}
...
Fl_Image_Button::Fl_Image_Button(int a,int b,int c,int d,int nr,int nc,const char* e):Fl_Button(a,b,c,d,e)
{
	row = nr;
	col = nc;
	upimage=NULL;
